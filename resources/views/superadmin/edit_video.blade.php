<x-app-layout>
    ...
    <form method="post" action="{{ route('superadmin.video.update', $video->value('id')) }}" class="form-horizontal">
        @csrf
        @method('put')
                        ...
                        <div class="flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <textarea
                                    ...
                                    id="description_ar" name="description_ar" rows="3" cols="3">{{ $video->value('description_ar') }}</textarea>
                            </div>
                            <div class="w-full md:w-1/2 px-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                    for="description_en">
                                ...
                                <textarea
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-5 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                    id="description_en" name="description_en" rows="3" cols="3">{{ $video->value('description_en') }}</textarea>
                            </div>
