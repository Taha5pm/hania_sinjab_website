<x-app-layout>
    ...
    <form method="post" action="{{ route('superadmin.subscriber.update', $sub->value('id')) }}" class="form-horizontal">
        @csrf
        @method('put')
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <textarea
                                ...
                                id="email" name="email" rows="3" cols="3">{{ $sub->value('email') }}</textarea>
                        </div>
